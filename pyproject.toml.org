...
mkdocstrings  ="*"
# dep tools
deptry = { version = "*", python = ">=3.9" }

# testing tools
pytest = { version = ">=7.4.3", python = ">=3.9" }
pytest-cov = { version = ">=4.1.0", python = ">=3.9" }
pytest-xdist = { version = ">=3.5.0", python = ">=3.9" }
pytest-randomly = { version = ">=3.15.0", python = ">=3.9" }
pytest-sugar = { version = ">=0.9.7", python = ">=3.9" }
pytest-mock = { version = "*", python = ">=3.9" }
pytest-unused-fixtures = { version = "*", python = ">=3.9" }
hypothesis = { version = ">=6.96.0", python = ">=3.9" }
tox = { version = "*", python = ">=3.9" }

# tools
pylint = { version = ">=3.0.2", python = ">=3.9" }
ruff = { version = ">=0.1.9", python = ">=3.9" }
pre-commit = { version = ">=3.5.0", python = ">=3.9" }

# types
mypy = { version = ">=1.16.0", python = ">=3.9" }
types-toml = { version = "*", python = ">=3.9" }

# docs
interrogate = { version = ">=1.5.0", python = ">=3.9" }
pydoctest = { version = ">=0.1.22", python = ">=3.9" }
pdoc3 = { version = ">=0.10.0", python = ">=3.9" }
mdformat = { version = ">=0.7.17", python = ">=3.9" }
linkcheckmd = { version = ">=1.4.0", python = ">=3.9" }
codespell = { version = ">=2.2.6", python = ">=3.9" }
pyenchant = { version = ">=3.2.2", python = ">=3.9" }

# more testing (optional)
# pytest-snapshot = { version = ">=0.9.0", python = ">=3.9" }
# pytest-asyncio = { version = ">=0.23.2", python = ">=3.9" }
# anyio = { version = ">=4.2.0", python = ">=3.9" }
# trio = { version = ">=0.23.2", python = ">=3.9" }

# contract (optional)
# griffe = { version = ">=0.38.1", python = ">=3.9" }
