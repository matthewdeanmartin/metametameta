...
See [Installation](installation.md) to get started and [Usage](usage.md) for examples. Contributions are welcome; see [Contributing](CONTRIBUTING.md). Release work should follow the [pre-release checklist](PRERELEASE.md).
